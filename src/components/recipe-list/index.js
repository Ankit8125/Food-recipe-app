...
export default function RecipeList({ recipeList }) {
    // console.log(recipeList); // prints all recipeList like :servings, cookTimeMinutes, tags, userId, image..etc
    return ( // max-w : maximum width
        <div>
            <div className="p-4 mx-auto lg:max-w-6xl md:max-w-4xl sm:max-w-full">
                <h2 className="text-4xl font-bold text-gray-800 mb-12">Recipes</h2>
                <Link href={'/'}>Go Home</Link>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 hap-8">
                    {
