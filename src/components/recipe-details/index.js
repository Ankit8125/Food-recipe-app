            ...
            <div className="p-6 lg:max-w-6xl max-w-2xl mx-auto">
                <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-10">
                    <div className="w-full lg:sticky top-0 sm:flex gap-2">
                        <img src={getRecipeDetails.image} name={getRecipeDetails.name} className="w-4/5 rounded object-cover"/>
                    </div>
                    <div>
                        ...
                        <div className="mt-5">
                            ...
                            <ul className="space-y-3 list-disc mt-4 pl-4 text-sm text-gray-700">
                                { //space-y-3: adds vertical spacing (i.e: space-y) between the list items. The value 3 indicates the spacing size. 
                                // list-disc: list items should be displayed as disc bullets. | pl: padding-left
